    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="bg-white shadow-md p-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl font-bold text-indigo-600">Asistente Virtual con IA</h1>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 mt-8">
                ...
                <p className="text-lg font-semibold">¡Hola! Soy tu asistente virtual</p>
          ...
          <div className="border-t p-4">
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800"
                disabled={isLoading}
              />
              <button
                onClick={sendMessage}
